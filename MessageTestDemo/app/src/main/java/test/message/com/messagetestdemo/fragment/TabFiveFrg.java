...
public class TabFiveFrg extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.frg_five, null);
...
//        webView.loadUrl("file:///android_asset/test.html");//加载asset文件夹下html
        webView.loadUrl("http://i.zhixiaoren.com/m/service/?a=share_list&m_from_uid=");//加载url
